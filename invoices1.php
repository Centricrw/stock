...
if(isset($_GET['invoiceNo']))
{
	...
	//echo $purchaseOrder;
	$sql = $db->query("SELECT 
T.`transactionID`,T.description, T.`itemCode`,I.`itemName`,I.kode,
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
							...
							<li>
                                <a href="pinv.php" class="waves-effect waves-light"><i class="ion-clipboard"></i><span>Proforma Invoice</span></a>
                            </li>
							<li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="pull-left m-t-30">
                                                    <address>
                                                      <strong>MUHIRWA Clement/ CIRHUZA Alain.</strong><br>
                                                      KIGALI/ GASABO<br>
                                                      <abbr title="Email">E:</abbr> muhirwaclement@gmail.com/ cirhuzalain@gmail.com<br/>
                                                      <abbr title="Phone">P:</abbr> 0784848236/ 0786525059
                                                     </address>
                                                </div>
...
<abbr title="................................">Sign:</abbr>	<br/><br/>
And: CIRHUZA Alain<br/>						
<abbr title="................................">Sign:</abbr>	<br/><br/>						
