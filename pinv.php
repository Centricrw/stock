...
if ($existCount > 0) { 
	while($row = mysqli_fetch_array($sql)){ 
		...
		<p>Please contact: <br/><em>(+25) 078 145-1178</em><br/><b>irasaac@gmail.com</b></p>		
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li ><a href="invoices1.php" class="waves-effect waves-light active"><i class="ion-document"></i>Invoices</a></li>
                                    <li class="active"><a href="javascript:void()"  class="waves-effect waves-light"><i class="ion-clipboard"></i>Proforma Invoice</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="pull-left m-t-30">
                                                    <address>
                                                      <strong>DATA-SYSTEMS/GIRAICT.</strong><br>
                                                      KIGALI/ NYARUGENGE<br>
                                                      <abbr title="Tin number">TIN:</abbr> 000125488/763<br/>
                                                      <abbr title="Email">E:</abbr> info@giraict.rw<br/>
                                                      <abbr title="Phone">P:</abbr> 0788867992
                                                     </address>
                                                </div>
