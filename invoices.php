...
include "db.php"; 
$sql = $db->query("SELECT * FROM users WHERE username='$username' AND pwd='$password' LIMIT 1"); // query the person
                                            ...
                                            <div class="col-md-12">
                                                <div class="pull-left m-t-30">
                                                    <address>
                                                      ...
                                                      <abbr title="Email">E:</abbr> info@chrevo.rw<br/>
                                                      <abbr title="Phone">P:</abbr> 0788600946
                                                     </address>
                                                </div>
