                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li  class="active"><a href="javascript:void()" class="waves-effect waves-light active">Faster | Slow Items</a></li>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div id="userResurts" class="inbox-widget nicescroll mx-box">
                                            <?php
											$sqltotalperUser = $db->query("SELECT T.itemCode, I.itemName, T.operation, sum(T.qty) IGITERANYO
																			FROM transactions T
																			inner join items I
																			on I.itemId = T.itemCode
																			WHERE T.operation = 'out'
                                                                            AND T.companyId = '$SessioncompanyId'
																			Group by T.itemCode
																			ORDER BY IGITERANYO DESC");
												$n = 0;
							...
							<div class="col-lg-8">
                                <div class="panel panel-default">
									...
									<div class="panel-body">
                                       ...
                                       <h5 class="text-success"><center>Click on the Item If You Made any transaction</center></h5>
										</div>
                                    </div>
                                </div>
                            </div> <!-- end col -->
